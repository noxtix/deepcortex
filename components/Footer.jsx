...
export default function Footer() {
    return (
        <footer className="bg-slate-900 border-t border-slate-800 pt-10 pb-6 mt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Bottom Bar */}
                <div className="border-t border-slate-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-slate-600 text-[10px]">
